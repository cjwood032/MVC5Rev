namespace MVC5Rev.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<MVC5Rev.Models.CompanyDbContext>
    {
        public Configuration()
        {
            AutomaticMigrationsEnabled = true;
            ContextKey = "MVC5Rev.Models.CompanyDbContext";
        }

        protected override void Seed(MVC5Rev.Models.CompanyDbContext context)
        {
